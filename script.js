...
function getFormResult() {
  ...
  // Nesse passo, vamos enviar para dentro da nossa variável form (que possui o id=evaluation-form) todos os dados puxados anteriormente, mas com a propriedade . value, pois queremos o valor desses dados, para melhor organização das concatenações estamos usando template literals.
  form.innerHTML =`
